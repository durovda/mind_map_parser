...
class TParser:
	...
	def parsLevel(self, level, nodes):
		currentNode = None
		for node in nodes:
...
class TestCaseStep:
	...
	def __init__(self, step, stepNumber, result = []):
		self.step = step
